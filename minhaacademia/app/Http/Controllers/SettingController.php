...
class SettingController extends Controller
{
    ...
    public function validateSettings(Request $request){
        ...
        $rules = [
            ...
            'youtubeChannelAbout' => ['required', 'string', 'max:512'],
        ...
        $error_messages = [
            ...
            'youtubeChannelAbout.required' => 'É obrigatório informar a seção :attribute',
            'youtubeChannelAbout.string' => 'A seção :attribute deve ser formada por caracteres alfanuméricos',
            'youtubeChannelAbout.max' => 'A seção :attribute deve ter no máximo 488 caracteres',// (512 caracteres no máximo em $rules['youtubeChannelAbout']) - (24 caracteres para inserir '\r\n' no final das linhas conforme necessário).
